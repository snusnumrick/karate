        ...
        <div className="min-h-screen bg-amber-50 dark:bg-gray-800 py-12 text-foreground">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md backdrop-blur-lg border dark:border-gray-700">
                    ...
                    <h1 className="text-3xl font-bold text-green-600 dark:text-green-400 mb-6">Waivers & Agreements</h1>
            ...
            <div className="space-y-4">
                {!isAuthenticated ? (
                    <p>Please <Link to="/login?redirectTo=/waivers" className="text-green-600 dark:text-green-400 hover:underline">log
