        ...
        <div className="mt-12 bg-white dark:bg-gray-700 rounded-lg shadow-xl overflow-hidden">
          <div className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              <div>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Class Structure</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">What to Bring</h3>
                <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-300">
