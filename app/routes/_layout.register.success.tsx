    ...
    <div className="min-h-screen bg-amber-50 dark:bg-gray-800 py-12 text-foreground flex items-center justify-center">
      <div className="max-w-md w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md text-center">
          ...
          <h1 className="text-2xl font-bold text-green-600 dark:text-green-400 mb-4">Registration Submitted!</h1>
          <p className="text-muted-foreground mb-6">
            Thank you for registering! Your information has been received. You can now log in to your account.
          </p>
