...
export default function AddStudentPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
       <Link to="/family" className="text-blue-600 hover:underline mb-6 inline-block">&larr; Back to Family Portal</Link>
      ...
      <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md border dark:border-gray-700">
        <Form method="post" className="space-y-6">
          ...
          <h2 className="text-xl font-semibold text-foreground mb-4 pb-2 border-b border-border dark:border-gray-700">Student Information</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <Input type="text" id="firstName" name="firstName" required className="focus:ring-green-500" />
            </div>
            <div>
              <Label htmlFor="lastName" className="block text-sm font-medium mb-1">
                Last Name<span className="text-red-500">*</span>
              </Label>
              <Input type="text" id="lastName" name="lastName" required className="focus:ring-green-500" /* defaultValue={studentLastName} */ />
            </div>
            <div>
              <Label htmlFor="birthDate" className="block text-sm font-medium mb-1">
                Birth Date<span className="text-red-500">*</span>
              </Label>
              <Input type="date" id="birthDate" name="birthDate" required className="focus:ring-green-500 dark:[color-scheme:dark]" />
            </div>
            <div>
              ...
              <Select name="gender" required>
                <SelectTrigger id="gender" className="w-full focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
             ...
             <div>
              ...
              <Select name="tShirtSize" required>
                <SelectTrigger id="tShirtSize" className="w-full focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
            ...
            <div>
              ...
              <Select name="gradeLevel" required>
                <SelectTrigger id="gradeLevel" className="w-full focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
             ...
             <div>
              ...
              <Select name="beltRank">
                <SelectTrigger id="beltRank" className="w-full focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
          ...
          <h2 className="text-xl font-semibold text-foreground mt-8 mb-4 pb-2 border-b border-border dark:border-gray-700">Optional Information</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             <div>
            ...
            <div>
              ...
              <Select name="immunizationsUpToDate">
                <SelectTrigger id="immunizationsUpToDate" className="w-full focus:ring-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
            ...
            <div className="md:col-span-2">
              ...
              <Textarea id="immunizationNotes" name="immunizationNotes" rows={3} className="focus:ring-green-500" />
            </div>
          </div>
  ...
  return (
     <div className="container mx-auto px-4 py-8">
       ...
       <Alert variant="destructive">
         <AlertTitle>Error</AlertTitle>
         <AlertDescription>
           There was an error loading or processing the add student form. Please try again or go back to the family portal.
         </AlertDescription>
       </Alert>
     </div>
  );
