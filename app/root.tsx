...
export function ErrorBoundary() {
  ...
  // Render a full HTML document structure within the ErrorBoundary
  // to ensure styles and theme are applied correctly even for root errors.
  return (
    <html lang="en" className="h-full" suppressHydrationWarning>
      <head>
        <meta charSet="utf-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover" />
        {/* Minimal necessary meta/links for error page */}
