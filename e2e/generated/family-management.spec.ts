...
test.describe('Family Management', () => {
  ...
  test.skip('smoke: /admin/families/:familyId loads successfully', async ({ page }) => {
    // SKIPPED: route contains dynamic parameters that require real IDs.
    // Navigating to "/admin/families/:familyId" literally would send ":familyId" etc. to the
    ...
    // Example: '/admin/families/:familyId'.replace(':familyId', process.env.TEST_FAMILY_ID ?? '')
  });
