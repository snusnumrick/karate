...
test.describe('Attendance System', () => {
  ...
  test('smoke: /admin/attendance/ loads successfully', async ({ page }) => {
  ...
  test('smoke: /admin/attendance/record loads successfully', async ({ page }) => {
    // Collect JS errors before navigation
    const errors = [];
    page.on('pageerror', err => errors.push(err.message));
  ...
  test('smoke: /admin/attendance/report loads successfully', async ({ page }) => {
    // Collect JS errors before navigation
    const errors = [];
    page.on('pageerror', err => errors.push(err.message));

    await page.goto('/admin/attendance/report');
  ...
  // /family/attendance, /family/student/:studentId/attendance, /instructor/attendance

  
  test('access: admin can access /admin/attendance/', async ({ page }) => {
