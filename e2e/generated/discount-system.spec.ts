...
test.describe('Discount System', () => {
  ...
  test.skip('smoke: /admin/automatic-discounts/:ruleId loads successfully', async ({ page }) => {
    // SKIPPED: route contains dynamic parameters that require real IDs.
    // Navigating to "/admin/automatic-discounts/:ruleId" literally would send ":familyId" etc. to the
    ...
    // Example: '/admin/automatic-discounts/:ruleId'.replace(':familyId', process.env.TEST_FAMILY_ID ?? '')
  });
